    ...
    public class BinaryTree
    {
        ...
        public Node BFSSearch(int val)
        {
            ...
            while (queue.Count > 0)
            {
                ...
                Console.WriteLine($"Dequeued node - {node.Data}");

                if (node.Data == val)
                {
                    searchedNode = node;
                    Console.WriteLine($"Searched node - {node.Data}");
                    break;
                }
        ...
        public Node DFSSearch(int val)
        {
            ...
            {
                Node node = stack.Pop();
                Console.WriteLine($"Poped node - {node.Data}");
